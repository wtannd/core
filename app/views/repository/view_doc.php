...
<body>
    ...
    <div class="document-viewer">
            ...
            <div class="meta-info">
                ...
                <span>Submitted on: <?php echo date('F d, Y', strtotime($doc['submission_time'])); ?></span>
            </div>
        ...
        <div class="abstract-section">
            <h3>Abstract</h3>
            <p><?php echo nl2br(htmlspecialchars($doc['abstract'])); ?></p>
        </div>
        ...
        <?php if ($hasSupplFile): ?>
            <a href="/stream?type=suppl&id=<?php echo $doc['dID']; ?>" class="suppl-download">
        ...
        <div class="pdf-viewer">
            ...
            <?php else: ?>
                <p><em>No PDF file uploaded for this document.</em></p>
            <?php endif; ?>
        </div>
    </div>
    </main>
